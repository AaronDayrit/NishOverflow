...
namespace Project_3_StackOverflow.Controllers
{
    public class TagController : Controller
    {
        ...
        public TagController(NishOverflowContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Tags != null ? 
                          ...
                          Problem("Entity set 'NishOverflowContext.Tags'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NishOverflowContext.Tags'  is null.");
            }
            var tag = await _context.Tags.FindAsync(id);
            if (tag != null)
            {
